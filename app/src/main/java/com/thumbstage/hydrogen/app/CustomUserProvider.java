...
public class CustomUserProvider implements LCChatProfileProvider {
    ...
    // 此数据均为模拟数据，仅供参考
    static {
        partUsers.add(new LCChatKitUser("a", "a", "http://www.avatarsdb.com/avatars/tom_and_jerry2.jpg"));
        partUsers.add(new LCChatKitUser("b", "b", "http://www.avatarsdb.com/avatars/jerry.jpg"));
