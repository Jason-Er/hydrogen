 ...
 */
public class FitCenterDrawable extends Drawable {

    @NonNull
    private final Drawable target;

    public FitCenterDrawable(@NonNull Drawable target) {
        this.target = target;
    }
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        matrix.setRectToRect(sourceRect, screenRect, Matrix.ScaleToFit.CENTER);
