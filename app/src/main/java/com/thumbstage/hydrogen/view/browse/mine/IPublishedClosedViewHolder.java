...
public class IPublishedClosedViewHolder extends RecyclerView.ViewHolder {
    ...
    public IPublishedClosedViewHolder(@NonNull View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
        itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EventBus.getDefault().post(new BrowseItemEvent(mic, IPublishedClosedViewHolder.class.getSimpleName()));
            }
        });
    }
