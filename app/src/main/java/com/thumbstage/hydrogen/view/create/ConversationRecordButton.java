 ...
 * 录音的按钮
 */
public class ConversationRecordButton extends AppCompatButton {
  ...
  public ConversationRecordButton(Context context) {
    super(context);
    init();
  }

  public ConversationRecordButton(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init();
  }

  public ConversationRecordButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
