...
public class PublishedOpenedAdapterDelegate implements IAdapterDelegate<List> {

    private int viewType;

    public PublishedOpenedAdapterDelegate(int viewType) {
    ...
    public void onBindViewHolder(@NonNull List items, int position, @NonNull RecyclerView.ViewHolder holder) {
        ((PublishedOpenedViewHolder)holder).setMic((Mic) items.get(position));
    }
